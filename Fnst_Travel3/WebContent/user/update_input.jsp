...
<body >
<center>
<form action="<%=path%>/back/updateUser.action" method="post" onsubmit="return check();">
<input type="hidden" value="${user.id}" name="id">
<input type="hidden" value="${user.flag}" name="flag">
<TABLE class="tableEdit" border="0" cellspacing="1" cellpadding="0" style="width:300px;">
	<TBODY>
		<TR>
			<!-- 这里是添加、编辑界面的标题 -->
			<td align="center" class="tdEditTitle">修改管理员信息</TD>
		</TR>
		<TR>
			<td>
			<!-- 主输入域开始 -->
...
<table class="tableEdit" style="width:300px;" cellspacing="0" border="0" cellpadding="0">
	...
	<tr>	
		...
		<td class="tdEditContent"><input class="inputinfo" type="text" name="username" value="${user.username}" readonly="readonly">
	</tr>
