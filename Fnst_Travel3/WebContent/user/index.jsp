...
<center>
      <TABLE width="778" border=0 cellPadding=0 cellSpacing=0 borderColor=#ffffff bgColor=#dee7ff style="FONT-SIZE: 10pt">
        <TBODY>
          ...
          bgColor=#dee7ff><FONT color=#f7f7f7> 管理员管理<font color="#FFFFFF">&nbsp;</font></FONT> </TD>
      ...
      <TABLE width="778" style="border:solid 1px #abcabc;" align=center cellPadding=0 cellSpacing=0 borderColor=#ffffff style="FONT-SIZE: 10pt">
        <TBODY>
          ...
          <TR>
            ...
            */
            %>
            <a href="#" onclick="openWin('<%=path%>/back/addInputUser.action','addperson',400,200);">添加管理员信息</a>
      ...
      <table width="778" border="0" cellPadding="0" cellSpacing="1" bgcolor="#6386d6">
	      ...
	      <tr bgcolor="#EFF3F7" class="TableBody1">
		      <td width="22%" height="37" align="center"><B>用户名</B></td>
		      <td width="22%" height="37" align="center"><b>密码</b></td>
              <td width="22%" height="37" align="center"><b>姓名</b></td>
	      ...
	      <tr bgcolor="#EFF3F7" class="TableBody1" onmouseover="this.bgColor = '#DEE7FF';" onmouseout="this.bgColor='#EFF3F7';">
	          ...
	          <td align="center" vAlign="center">
	           <a href="#" onclick="openWin('<%=path%>/back/updateInputUser.action?id=${user.id}','updateUser',400,250);">更新</a>
	           
	          <a href="#" onclick="del('<%=path%>/back/delUser.action?id=${user.id }');">删除</a>
	          
	          <a href="#" onclick="reset('<%=path%>/back/resetPasswordUser.action?id=${user.id }');">重置密码</a>
      ...
      <TABLE width="778" border=0 align=center cellPadding=0 cellSpacing=0 borderColor=#ffffff style="FONT-SIZE: 10pt">
        <TBODY>
          <TR>
            ...
            <!-- 可以在这里插入分页导航条 -->
   <pg:pager url="../back/listUser.action" items="${pm.total}"  maxPageItems="${pageSize}"  export="currentPageNumber=pageNumber">
