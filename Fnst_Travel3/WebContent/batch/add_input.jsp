...
<body>
<center>
<form action="<%=path%>/back/addBatch.action" method="post">
<TABLE class="tableEdit" border="0" cellspacing="1" cellpadding="0" style="width:500px;">
	<TBODY>
		<TR>
			<!-- 这里是添加、编辑界面的标题 -->
			<td align="center" class="tdEditTitle">添加批次信息</TD>
		</TR>
		<TR>
			<td>
			<!-- 主输入域开始 -->
...
<tr>
		...
		id="YearthNameId" disabled="disabled">
		<input name="yearId" type="hidden" id="YearthIdId">
		<input type="button" value="选择" style="width:60px"
		onclick="openWin3('<%=path%>/back/listYearth.action?select=true','selectOrgs',600,400,1);">
		</td>
	</tr>
	<tr>
	    <td class="tdEditLabel" width="80px">编&nbsp;&nbsp;&nbsp;&nbsp;号</td>			
		<td align="left" class="tdEditContent"><input class="inputinfo" type="text" 
		name="batchNo" readonly="readonly" id="batchNoId"></td>
	</tr>
	
	
	<tr>	
		<td  width="80px" class="tdEditLabel" >名&nbsp;&nbsp;&nbsp;&nbsp;称</td>			
		<td align="left" class="tdEditContent"><input class="inputinfo" type="text" 
		name="name"></td>
	</tr>
	...
	<tr>	
		...
		<td align="left" class="tdEditContent"><input class="inputinfo" type="text" 
		name="subsidy" id="subsidyID" value="3500"></td>
	</tr>
	
	<tr>	
		<td width="80px" class="tdEditLabel" >关联批次</td>			
		<td align="left" class="tdEditContent"><input class="inputinfo" type="text" 
		name="relationBatch"></td>
	</tr>
	
	<tr>
	   		<td width="80px" class="tdEditLabel" >备&nbsp;&nbsp;注</td>			
		<td align="left" class="tdEditContent"><textarea class="inputinfo" name="remarks" rows="6" cols="16"></textarea></td>
	</tr>
</table>
